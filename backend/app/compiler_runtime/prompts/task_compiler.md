...
- Before returning the Plan, mechanically verify that every roots, depends_on, and upstream_check_ids reference exactly matches an emitted node id. After splitting or renaming a CHECK, remove every stale alias.
